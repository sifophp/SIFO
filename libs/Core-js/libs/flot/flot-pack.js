...
/*  tabledatatoflotabstract  */
var TableDataToFlotAbstract = function()
{
	this.oTable = null;
	this.oThead = null;
	this.oTbody = null;
...
TableDataToFlotAbstract.prototype.applyTo = function(oTable)
{
	throw new Error("This method must be overwritten in extended classes.");
};
TableDataToFlotAbstract.prototype._setThead = function()
{
	this.oThead = this.oTable.getElementsByTagName("thead")[0];
	this._setHeaders();
	return this;
};
TableDataToFlotAbstract.prototype._setTbody = function()
{
	this.oTbody = this.oTable.getElementsByTagName("tbody")[0];
	return this;
};
TableDataToFlotAbstract.prototype._setBodyRows = function()
{
	throw new Error("This method must be overwritten in extended classes.");
};
TableDataToFlotAbstract.prototype._getCellsInRow = function(oRow)
{
	return oRow.cells;
};
TableDataToFlotAbstract.prototype._setHeaders = function()
{
	throw new Error("This method must be overwritten in extended classes.");
};
TableDataToFlotAbstract.prototype.getData = function()
{
	throw new Error("This method must be overwritten in extended classes.");
};

/*  tabledatatoflot  */
var TableDataToFlot = function()
{
	var baseConstructor = TableDataToFlotAbstract;
	baseConstructor.call(this);
	baseConstructor = null;
};
TableDataToFlot.prototype = new TableDataToFlotAbstract();
TableDataToFlotAbstract.prototype.applyTo = function(oTable)
{
	this.oTable = oTable;
	//this.oTable.style.display="none";
	this._setThead()._setTbody()._setBodyRows();
	return this;
};
TableDataToFlotAbstract.prototype._setBodyRows = function()
{
	this.aRows = this.oTbody.getElementsByTagName("tr");
	return this;
};
TableDataToFlotAbstract.prototype._setHeaders = function()
{
	this.aHeaders = this.oThead.getElementsByTagName("th");
	return this;
};
TableDataToFlotAbstract.prototype.getData = function()
{
	...
	for(var nColumn = 1, nColumns = this.aHeaders.length-1; nColumn <= nColumns; ++nColumn)
	{
		for(var nRow = 0, nLenRows = this.aRows.length; nRow < nLenRows; nRow++)
		{
			oRow = this.aRows[nRow];
			aCells = this._getCellsInRow(oRow);
			aAux = [parseFloat(aCells[0].innerHTML), parseFloat(aCells[nColumn].innerHTML)];
			aAuxRowData.push(aAux);
		}
		aData.push({data: aAuxRowData, label:this.aHeaders[nColumn].innerHTML});
		aAuxRowData = [];
	}
	return aData;
};
TableDataToFlot.getDataFrom = function(oTable)
{
	var oTableData = new TableDataToFlot();
	return oTableData.applyTo(oTable).getData();
};
...
var Legend = function()
{
    ...
    this.sLabelBoxBorderColor = "";
};
Legend.prototype.setPosition = function(sPosition)
{
    this.sPosition = sPosition;
    return this;
};
Legend.prototype.setMarginLeft = function(nMarginLeft)
{
    this.nMarginLeft = nMarginLeft;
    return this;
};
Legend.prototype.setMarginTop = function(nMarginTop)
{
    this.nMarginTop = nMarginTop;
    return this;
};
Legend.prototype.setBackgroundColor = function(sBackgroundColor)
{
    this.sBackgroundColor = sBackgroundColor;
    return this;
};
Legend.prototype.setLabelBoxBorderColor = function(sLabelBoxBorderColor)
{
    this.sLabelBoxBorderColor = sLabelBoxBorderColor;
    return this;
};
...
{
    this.bShow = true;
    this.fpFormatMessage = function(sId, nX, nY)
    {
    };
    this.sPosition = "";
    this.sDisplay = "";
...
Tooltip.prototype.show = function(bShow)
{
    this.bShow = bShow;
    return this;
};
Tooltip.prototype.getLeftPosition = function(nLeft)
{
    nLeft = nLeft + this.nLeft;
	return nLeft;
};
Tooltip.prototype.getTopPosition = function(nTop)
{
    nTop = nTop + this.nTop;
	return nTop;
};
Tooltip.prototype.getCssFromParams = function(nTop, nLeft)
{
    var oOptions =
    {
        position: this.sPosition,
        display: this.sDisplay,
        zIndex: 99999,
        top: nTop,
        left: nLeft,
        background: this.sBackground,
        fontSize: this.sFontSize,
        fontFamily: this.sFontFamily,
        fontWeight: this.sFontWeight,
        border: this.nBorder,
        padding: this.sPadding,
        opacity: this.nOpacity
    };
    if (this.sBackgroundColor)
    {
        oOptions.backgroundColor = this.sBackgroundColor;
    }
    return oOptions;
};
Tooltip.prototype.insertIntoDom = function(nLeftCorrection, nTopCorrection, sContents, sId)
{
    var oDiv = undefined;
    if (!document.getElementById(sId))
    {
        ...
        oDiv.id = sId;
        oDiv.innerHTML = sContents;
    }

    var nTop = this.getTopPosition(nTopCorrection);
    var nLeft = this.getLeftPosition(nLeftCorrection);
    $(oDiv).css(this.getCssFromParams(nTop, nLeft)).appendTo(document.body).fadeIn(100);
};
Tooltip.prototype.setFormatMessage = function(fpFormatMessage)
{
    this.fpFormatMessage = fpFormatMessage;
    return this;
};
Tooltip.prototype.setPosition = function(sPosition)
{
    this.sPosition = sPosition;
    return this;
};
Tooltip.prototype.setDisplay = function(sDisplay)
{
    this.sDisplay = sDisplay;
    return this;
};
Tooltip.prototype.setTop = function(nTop)
{
    this.nTop = nTop;
    return this;
};
Tooltip.prototype.setLeft = function(nLeft)
{
    this.nLeft = nLeft;
    return this;
};
Tooltip.prototype.setBackground = function(sBackground)
{
    this.sBackground = sBackground;
    return this;
};
Tooltip.prototype.setFontSize = function(sFontSize)
{
    this.sFontSize = sFontSize;
    return this;
};
Tooltip.prototype.setFontFamily = function(sFontFamily)
{
    this.sFontFamily = sFontFamily;
    return this;
};
Tooltip.prototype.setFontWeight = function(sFontWeight)
{
    this.sFontWeight = sFontWeight;
    return this;
};
Tooltip.prototype.setBorder = function(nBorder)
{
    this.nBorder = nBorder;
    return this;
};
Tooltip.prototype.setPadding = function(sPadding)
{
    this.sPadding = sPadding;
    return this;
};
Tooltip.prototype.setOpacity = function(nOpacity)
{
...
var GridBackgroundColor = function()
{
    this.aColors = [];
    this.sTickColor = "";
    this.nBorderWidth = 0;
...
GridBackgroundColor.prototype.setColors = function(aColors)
{
    this.aColors = aColors;
    return this;
};
GridBackgroundColor.prototype.setTickColor = function(sTickColor)
{
    this.sTickColor = sTickColor;
    return this;
};
GridBackgroundColor.prototype.setBorderWidth = function(nBorderWidth)
{
    this.nBorderWidth = nBorderWidth;
    return this;
};
GridBackgroundColor.prototype.setBorderColor = function(sBorderColor)
{
...
var Grid = function()
{
    this.bHoverable = false;
    this.bClickable = false;
    this.oBackgroundColor = new GridBackgroundColor();
};
Grid.prototype.setHoverable = function(bHoverable)
{
    this.bHoverable = bHoverable;
    return this;
};
Grid.prototype.setClickable = function(bClickable)
{
    this.bClickable = bClickable;
    return this;
};
Grid.prototype.setBackgroundColor = function(oBackgroundColor)
{
...
var Axys = function()
{
    this.fpTickFormatter = function()
    {
    };
};
Axys.prototype.setTickFormatter = function(fpTickFormatter)
{
    this.fpTickFormatter = fpTickFormatter;
    return this;
};


var ChartNoData = function()
{
    this.bDraw = false;
    this.sMessage = "";
    this.sImage = null;
...
ChartNoData.prototype.setDraw = function(bDraw)
{
    this.bDraw = bDraw;
    return this;
};
ChartNoData.prototype.setMessage = function(sMessage)
{
    this.sMessage = sMessage;
    return this;
};
ChartNoData.prototype.setImage = function(sImage)
{
    this.sImage = sImage;
    return this;
};
ChartNoData.prototype.setWidth = function(nWidth)
{
    this.nWidth = nWidth;
    return this;
};
...
var Chart = function()
{
    ...
    this.aAxys = [];
    this.aColors = [];
    this.oLegend = new Legend();
    this.oNoData = new ChartNoData();
    this.oOptions = null;
    this.sUrlExternalOptions = '';
    this.oTooltip = new Tooltip();
    this.bDrawOnDocumentReady = false;
    this.onGetExternalOptions = function()
    {
    };
    this.oPreviousPoint = null;
};
Chart.prototype.setContainer = function(oContainer)
{
    this.oContainer = oContainer;
    return this;
};
Chart.prototype.setWidth = function(nWidth)
{
    this.nWidth = nWidth;
    return this;
};
Chart.prototype.setHeight = function(nHeight)
{
    this.nHeight = nHeight;
    return this;
};
Chart.prototype.setClasses = function(oClasses)
{
    this.oClasses = oClasses;
    return this;
};
Chart.prototype.setData = function(oData)
{
    this.oData = oData;
    return this;
};
Chart.prototype.showLines = function(bLines)
{
    this.bLines = bLines;
    return this;
};
Chart.prototype.showBars = function(bBars)
{
    this.bBars = bBars;
    return this;
};
Chart.prototype.showPoints = function(bPoints)
{
    this.bPoints = bPoints;
    return this;
};
Chart.prototype.setSelectionMode = function(sSelectionMode)
{
    this.sSelectionMode = sSelectionMode;
    return this;
};
Chart.prototype.setFont = function(sFont)
{
    this.sFont = sFont;
    return this;
};
Chart.prototype.setColor = function(sColor)
{
    this.sColor = sColor;
    return this;
};
Chart.prototype.setGrid = function(oGrid)
{
    this.oGrid = oGrid;
    return this;
};
Chart.prototype.setAxys = function(aAxys)
{
    this.aAxys = aAxys;
    return this;
};
Chart.prototype.setXaxys = function(oAxys)
{
    this.aAxys.X = oAxys;
    return this;
};
Chart.prototype.setYaxys = function(oAxys)
{
    this.aAxys.Y = oAxys;
    return this;
};
Chart.prototype.setColors = function(aColors)
{
    this.aColors = aColors;
    return this;
};
Chart.prototype.setLegend = function(oLegend)
{
    this.oLegend = oLegend;
    return this;
};
Chart.prototype.setNoData = function(oNoData)
{
    this.oNoData = oNoData;
    return this;
};
Chart.prototype.setOptions = function(oOptions)
{
    this.oOptions = oOptions;
    return this;
};
Chart.prototype.setExternalUrl = function(sUrlExternalOptions)
{
    this.sUrlExternalOptions = sUrlExternalOptions;
    return this;
};
Chart.prototype.getExternalOptions = function()
{
    var self = this;
    $.ajax(
    {
        url: this.sUrlExternalOptions,
        type: "GET",
        dataType: "json",
        success: function(oJSON)
        {
            self.onGetExternalOptions();
        }
    });
};
Chart.prototype.bindTooltipBehaviour = function()
{
    var self = this;
    $(this.oContainer).bind("plothover", function(eEvent, nPos, oItem)
    {
        var sContainerId = eEvent.target.id + "-tooltip";
        var oElement = document.getElementById(sContainerId);
        if (null != oItem)
        {
            if (self.oPreviousPoint != oItem.datapoint)
            {
                self.oPreviousPoint = oItem.datapoint;
                $(oElement).remove();
                var nLeftCorrection = oItem.datapoint[0].toFixed(2);
                var nTopCorrection = oItem.datapoint[1].toFixed(2);
                var sMessage = self.oTooltip.fpFormatMessage(eEvent.target.id, nLeftCorrection, nTopCorrection);

                self.oTooltip.insertIntoDom(oItem.pageX, oItem.pageY, sMessage, sContainerId);
                $(this.oContainer).bind("mouseout", function()
                {
                    $("#download_chart_layer-tooltip").remove();
                    $(this.oContainer).unbind("mouseout");
                });
                if ($(document.getElementById("nyroModalFull")).filter(":visible").length > 0)
                {
        ...
        {
            $(oElement).remove();
            self.oPreviousPoint = null;
        }
    });
};
Chart.prototype.setTooltip = function(oTooltip)
{
    this.oTooltip = oTooltip;
    return this;
};
Chart.prototype.setDrawOnDocumentReady = function(bDrawOnDocumentReady)
{
    this.bDrawOnDocumentReady = bDrawOnDocumentReady;
    return this;
};
...
Chart.prototype.applyStyle = function()
{
    var oClassSeparator = "";
    if (this.oContainer.className.split(" ").length > 0)
    {
        oClassSeparator = "";
    }
    this.oContainer.className += oClassSeparator + this.oClasses.chart;
    var oContStyle = this.oContainer.style;

    oContStyle.font = this.sFont;
    oContStyle.width = this.nWidth + "px";
    oContStyle.height = this.nHeight + "px";
    oContStyle.color = this.sColor;
    oContStyle = oClassSeparator = null;
};
Chart.prototype.init = function()
{
    this.applyStyle();
    this.drawChart();
    this.bindTooltipBehaviour();
};

/*  chartflot  */
var ChartFlot = function()
{
	var baseConstructor = Chart;
	baseConstructor.apply(this,arguments);
	baseConstructor = null;
};
ChartFlot.prototype = new Chart();
ChartFlot.prototype.getOptionsFlotFormat = function()
{
	var oOptions =  {
		lines: {show: this.bLines},
		points: {show: this.bPoints},
		selection: {mode: this.sSelectionMode},
		grid: {
			hoverable: this.oGrid.bHoverable,
			clickable: this.oGrid.bClickable,
			backgroundColor: {
				colors: this.oGrid.oBackgroundColor.aColors
			},
			borderWidth: this.oGrid.oBackgroundColor.nBorderWidth,
			borderColor: this.oGrid.oBackgroundColor.sBorderColor,
			tickColor: this.oGrid.oBackgroundColor.sTickColor
		},
		xaxis: {
			tickFormatter: this.aAxys.X.fpTickFormatter
		},
		colors: this.aColors,
		legend: {
			position: this.oLegend.sPosition,
			margin: [ this.oLegend.nMarginLeft, this.oLegend.nMarginTop ],
			backgroundColor: this.oLegend.sBackgroundColor,
			labelBoxBorderColor: this.oLegend.sLabelBoxBorderColor
		},
		whenNoData: {
			draw: this.oNoData.bDraw,
			message: this.oNoData.sMessage,
			image: this.oNoData.sImage,
			width: this.oNoData.nWidth
		},
		drawChartWhenDocumentReady: this.bDrawOnDocumentReady,
		externalOptionsSource: null,
		tooltip: {
			show: this.oTooltip.bShow,
			formatMessageCallback: this.oTooltip.fpFormatMessage,
			position: this.oTooltip.sPosition,
			display: this.oTooltip.sDisplay,
			top: this.oTooltip.nTop,
			left: this.oTooltip.nLeft,
			background: this.oTooltip.sBackground,
			'font-size': this.oTooltip.sFontSize,
			'font-family': this.oTooltip.sFontFamily,
			border: this.oTooltip.nBorder,
			'font-weight': this.oTooltip.sFontWeight,
			padding: this.oTooltip.sPadding,
			opacity: this.oTooltip.nOpacity
		}
	};
	if(typeof this.aAxys.Y != "undefined" && this.aAxys.Y !== null)
	{
		oOptions.yaxis = {
			tickFormatter: this.aAxys.Y.fpTickFormatter
		};
	}
	return oOptions;
};
ChartFlot.prototype.drawChart = function()
{
	$.plot( this.oContainer, this.oData, this.getOptionsFlotFormat() );
};