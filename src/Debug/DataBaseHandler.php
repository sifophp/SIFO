...
class DataBaseHandler
{
    ...
    function __construct()
    {
        ...
        try {
            ...
            $this->persistence->setAttribute(PDO::ATTR_ERRMODE,
                PDO::ERRMODE_EXCEPTION); // Set database errors mode to exceptions
    ...
    public function getExecutionDebugWithChildrenById($execution_key)
    {
        try {
            $query =
                "SELECT execution_key, url, debug_content, is_json, is_pinned, timestamp, parent_execution_key FROM $this->table_name WHERE execution_key = :execution_key OR parent_execution_key = :execution_key";
