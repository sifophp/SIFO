...
class GdThumb extends ThumbBase
{
	 ...
	 * @return GdThumb
	 */
	public function adaptiveResize ($width, $height, $cropX = null, $cropY = null)
	{
		// make sure our arguments are valid
		...
		if (null === $cropX && $this->currentDimensions['width'] > $this->maxWidth)
		{
			$cropX = intval(($this->currentDimensions['width'] - $this->maxWidth) / 2);
		}
		elseif (null === $cropY && $this->currentDimensions['height'] > $this->maxHeight)
		{
