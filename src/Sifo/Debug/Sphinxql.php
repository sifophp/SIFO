...
class DebugSphinxql extends Sphinxql
{
    ...
    public function multiQuery($tag = null)
    {
        ...
        foreach ($this->queries as $key => $query) {
            ...
            $query_info['resultset'] = (!empty($sphinx_results[$key])) ? $sphinx_results[$key] : [];
    ...
    public function addQuery(
        ...
        $this->queries[] = ['query' => $prepared_query . ';', 'tag' => $tag];
    ...
    public function getCallerClass()
    {
        ...
        foreach (array_reverse($array_debug) as $debug_step) {
            ...
            if (in_array($debug_step['function'], ['query', 'multiQuery'])) {
                break;
            }
        }
