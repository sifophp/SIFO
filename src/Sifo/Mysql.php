...
class Mysql
{
    ...
    public function __construct($profile)
    {
        ...
        if (!empty($this->db_params['db_init_commands'])) {
            $init_commands = [PDO::MYSQL_ATTR_INIT_COMMAND => implode(';', $this->db_params['db_init_commands'])];
        }
        ...
        $this->pdo->setAttribute(PDO::ATTR_STATEMENT_CLASS, [$class::STATEMENT_CLASS, [$this->pdo, $profile]]);
    }
