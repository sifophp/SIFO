...
include ROOT_PATH.'/vendor/sifophp/sifo/src/EpiClasses/EpiCurl.php';
 ...
 *
 * @deprecated Use Epi Classes (see vendor/sifophp/sifo/src/) instead.
 */
class Twitter
{
    /**
     ...
     * @var string
     */
    protected static $active_account;
     ...
     * formats: xml, json, rss, atom
     *
     * @param int    $page     Number of page to retrieve,.
     * @param int    $count    Specifies the number of statuses to retrieve. May not be greater than 200.
     * @param int    $since_id Returns only statuses with an ID greater than (that is, more recent than) the specified ID.
     ...
     * @param int    $count    Specifies the number of statuses to retrieve. May not be greater than 200, default 20.
     ...
     *
     * @param int $id The numerical ID of the status you're trying to retrieve (passed as string for non 64-bit machines)
     *
     * @return array
     */
     ...
     * @param int    $in_reply_to_id The ID of an existing status that the status to be posted is in reply to.
     ...
     * @param int    $since_id Returns only direct messages with an ID greater than (that is, more recent than) the specified ID
     ...
     * @param bool   $require_credentials Whether user needs to be authenticated or not.
     * @param bool   $http_post           Send data as a POST.
     *
     * @return array
     */
