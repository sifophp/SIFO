...
class Images
{
     ...
     * @return bool
     */
    public static function resizeAndSave($from, $to, $width, $height, $crop = false, $resizeUp = false, $transparency = false, $quality = 100)
    {
     ...
     * @return bool
     */
    public static function uploadResizeAndSave($post_file, $destination, $width, $height, $crop = false, $resizeUp = false, $transparency = false)
    {
