...
abstract class ImageController extends Controller
{
	...
	protected function customizeHeader()
	{
		...
		{
			throw new InternalServerError( "Please do the favour of use one (and only one) image content_type helper!" );
		}
	...
	{
        if ( Domains::getInstance()->getDevMode() && ( Filter\Cookie::getInstance()->getInteger( 'rebuild_all' ) || Filter\Get::getInstance()->getInteger( 'rebuild' ) ) )
		{
			return false;
		}
