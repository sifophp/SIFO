...
class Urls
{
     ...
     * @var string
     */
    public static $normalize_values = false;
    /**
     ...
     * @var string
     */
    private static $path_parts = array();
    /**
     ...
     * @var string
     */
    public static $actual_url = '';
    /**
     * Stores the definition of an URL.
     *
     * @var array
     */
    public static $url_definition = array();
    /**
     * Stores all the available URLs.
     *
     * @var array
     */
    private static $url_config = array();
     ...
     * @return string
     */
    public static function getUrl($url_config_key)
    {
     ...
     * @return array
     */
    public static function getUrlDefinition()
    {
