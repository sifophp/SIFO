...
class Form
{
     ...
     * @return boolean
     */
    public function validateSingleElement(
        $mandatory,
        $name,
        $filter_rule,
        $parameters = []
        ...
        $filter_result = call_user_func_array([$this->filter, $filter_rule], $total_params);
     ...
     */
    public function validateEqualElements(
        Array $names,
        $filter_rule,
        $parameters = []
    ) {
    ...
    public function validateElements($form_config)
    {
        ...
        foreach ($form_elements as $key => $element) {
            ...
            $single_element_validation = $this->validateSingleElement(
                ...
                (isset($element['params']) ? $element['params'] : []) // Passed params
            );
