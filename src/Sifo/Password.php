 ...
 *
 * Version 0.3 / Sifo version for PHP5 with namespaces.
 *
...
class Password
{
    ...
    private function crypt_private(
        $password,
        $setting
    ) {
        $output = '*0';
    ...
    /**
     * Returns the hash you'll need to store for the given password.
     *
     * @param $password
     * @return string
     */
    ...
    /**
     * Returns if a password is valid for a given hash.
     *
     * @param $password
     * @param $stored_hash
     * @return bool
