...
class Router
{
    protected static $reversal_map = array();
    protected static $routes_for_this_language = array();
     ...
     */
    public static function getUsedUrl()
    {
     ...
     * @return string
     */
    public static function getReversalRoute($translated_route)
    {
