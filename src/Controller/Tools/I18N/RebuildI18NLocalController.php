 ...
 */
class RebuildI18NLocalController extends Controller
{
    ...
    public function build()
    {
        ...
        $locales_available = $findI18N->getFilesystemFiles("instances/" . Bootstrap::$instance . "/locale");
        ...
        $literals = $findI18N->getLiterals(Bootstrap::$instance);
    ...
    {
        $translations_file = Bootstrap::$application . "/" . Bootstrap::$instance . "/locale/$locale";
...
namespace Common;\n"
    ...
    {
        $path = Bootstrap::$application . "/" . Bootstrap::$instance;
        ...
        if (file_exists($translations_file)) {
            ...
            die("File $locale not available for <strong>" . Bootstrap::$instance . "</strong>");
        }
    }
}
