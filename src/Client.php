...
class Client
{
    ...
    public static function getCountryCode($ip = null)
    {
        ...
        else
        {
            ...
            $gi           = geoip_open(ROOT_PATH . '/vendor/sifophp/sifo/libraries/GeoIP-Lite/GeoIP.dat', GEOIP_MEMORY_CACHE);
    ...
    public static function getBrowser($useragent = null, $return_array = false)
    {
        ...
        {
            require_once ROOT_PATH . '/vendor/sifophp/sifo/libraries/Browscap/Browscap.php';
            $bc      = new \phpbrowscap\Browscap(ROOT_PATH . '/vendor/sifophp/sifo/libraries/Browscap/');
    ...
    public static function getIP()
    {
        ...
        foreach (array('HTTP_CLIENT_IP', 'HTTP_X_FORWARDED_FOR', 'HTTP_X_FORWARDED', 'HTTP_X_CLUSTER_CLIENT_IP', 'HTTP_FORWARDED_FOR', 'HTTP_FORWARDED', 'REMOTE_ADDR') as
            $server_header)
        {
